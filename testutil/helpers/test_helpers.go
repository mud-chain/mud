...
import (
	...
	ethostypes "github.com/evmos/evmos/v12/types"
	fxstakingtypes "github.com/evmos/evmos/v12/x/staking/types"
)
...
func Setup(isCheckTx bool, isShowLog bool) *app.Evmos {
...
func DefGenesisState(cdc codec.Codec) app.GenesisState {
	genesis := app.NewDefAppGenesisByDenom(ethostypes.DefaultDenom, cdc)
	...
	bankState.Balances = append(bankState.Balances, banktypes.Balance{
		...
		Coins:   sdk.NewCoins(sdk.NewCoin(ethostypes.DefaultDenom, sdkmath.NewIntFromUint64(4_000).MulRaw(1e18))),
	})
...
func GenerateGenesisValidator(validatorNum int, initCoins sdk.Coins) (valSet *tmtypes.ValidatorSet, genAccs authtypes.GenesisAccounts, balances []banktypes.Balance) {
	if initCoins == nil || initCoins.Len() <= 0 {
		initCoins = sdk.NewCoins(sdk.NewCoin(ethostypes.DefaultDenom, sdkmath.NewInt(10_000).MulRaw(1e18)))
	}
...
func SetupWithGenesisValSet(t *testing.T, valSet *tmtypes.ValidatorSet, genAccs []authtypes.GenesisAccount, balances ...banktypes.Balance) *app.Evmos {
...
func AddTestAddrs(myApp *app.Evmos, ctx sdk.Context, accNum int, coins sdk.Coins) []sdk.AccAddress {
	return addTestAddrs(myApp, ctx, accNum, coins, CreateRandomAccounts)
}

func AddTestAddrsIncremental(myApp *app.Evmos, ctx sdk.Context, accNum int, coins sdk.Coins) []sdk.AccAddress {
	return addTestAddrs(myApp, ctx, accNum, coins, createIncrementalAccounts)
}

func addTestAddrs(myApp *app.Evmos, ctx sdk.Context, accNum int, coin sdk.Coins, strategy func(int) []sdk.AccAddress) []sdk.AccAddress {
...
func AddTestAddr(myApp *app.Evmos, ctx sdk.Context, addr sdk.AccAddress, coins sdk.Coins) {
...
func CheckBalance(t *testing.T, myApp *app.Evmos, addr sdk.AccAddress, balances sdk.Coins) {
...
func SignCheckDeliver(t *testing.T, txCfg client.TxConfig, app *baseapp.BaseApp, header tmproto.Header,
	...
	gasPrice := sdk.NewCoin(ethostypes.DefaultDenom, sdkmath.NewInt(4).MulRaw(1e12))
...
func SetupTestingApp() (ibctesting.TestingApp, map[string]json.RawMessage) {
	...
	return testingApp, app.NewDefAppGenesisByDenom(ethostypes.DefaultDenom, cfg.Codec)
}
...
func MintBlock(myApp *app.Evmos, ctx sdk.Context, block ...int64) sdk.Context {
