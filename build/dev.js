...
const main = async function () {
  ...
  try {
    ...
    if (init || isKeep) {
      ...
      const nodeKey = { priv_key: { type: "tendermint/PrivKeyEd25519", value: "iw+ypCQGoW+yJfd85ud+3LC1hHwBK1SLVTjXemC7b+iQSGSbrNMrjMzes0zV9nJyAF+mUk9qX+yNXfzB8YOyew==" } };
      const privValidatorConsensusKey = { address: "770D0E0C8C7464D68CF052E4627D315F18037F2C", pub_key: { type: "tendermint/PubKeyEd25519", value: "f1JHvKJwsfTAR3/DaEYziavEtJg99XBeQuVExiQ7CbA=" }, priv_key: { type: "tendermint/PrivKeyEd25519", value: "ERDjVJlJVmJoy7jIfxZDM9HB65aRgctMHUwO/nRrWvp/Uke8onCx9MBHf8NoRjOJq8S0mD31cF5C5UTGJDsJsA==" } };
      const createValidator = {
          ...
          messages: [
            {
              ...
              delegator_address: "ethos1hajh6rhhkjqkwet6wqld3lgx8ur4y3kh5cmp7f",
              validator_address: "ethosvaloper1hajh6rhhkjqkwet6wqld3lgx8ur4y3kha6vuh2",
              pubkey: { "@type": "/cosmos.crypto.ed25519.PubKey", key: "f1JHvKJwsfTAR3/DaEYziavEtJg99XBeQuVExiQ7CbA=" },
              value: { denom: "aethos", amount: "100000000000000000000" },
            },
          ],
          memo: "afef3a5f82fcf04b5e83f0e93b949a49fdbb6161@192.168.0.1:26656",
          timeout_height: "0",
          extension_options: [],
        ...
        signatures: ["aY+N+Jcy28ElIKk5yvfYzH1a6Icx20J+i3SCOHGuezlcK9tsgIjdi4UFZmEv2Ne2wOh9jH7AgyimiUgAqkmePAA="],
      };
