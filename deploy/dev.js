...
const main = async function () {
  ...
  try {
    ...
    if (init || isKeep) {
      ...
      const privValidatorConsensusKey = { address: 'BEBCB67095D4014190E0665CB277B6C54092C7F4', pub_key: { type: 'tendermint/PubKeyEd25519', value: 'vQyjluIV8QMftrDEicWCAFRrqDIJpB5uVRC0KUqigzY=' }, priv_key: { type: 'tendermint/PrivKeyEd25519', value: 'q5MvYI6RwF+jzHq4oDzqgkMAmdUHrqDc93csa0G3GKC9DKOW4hXxAx+2sMSJxYIAVGuoMgmkHm5VELQpSqKDNg==' } };
      const createValidator = { body: { messages: [{ '@type': '/cosmos.staking.v1beta1.MsgCreateValidator', description: { moniker: 'node0', identity: '', website: '', security_contact: '', details: '' }, commission: { rate: '0.100000000000000000', max_rate: '1.000000000000000000', max_change_rate: '1.000000000000000000' }, min_self_delegation: '1', delegator_address: 'mud1hajh6rhhkjqkwet6wqld3lgx8ur4y3khkw3zhq', validator_address: 'mudvaloper1hajh6rhhkjqkwet6wqld3lgx8ur4y3khdfjl3y', pubkey: { '@type': '/cosmos.crypto.ed25519.PubKey', key: 'vQyjluIV8QMftrDEicWCAFRrqDIJpB5uVRC0KUqigzY=' }, value: { denom: 'amud', amount: '100000000000000000000' } }], memo: 'e38f79893f569a56ae41d20559973a50f486e6ff@192.168.0.1:26656', timeout_height: '0', extension_options: [], non_critical_extension_options: [] }, auth_info: { signer_infos: [{ public_key: { '@type': '/ethermint.crypto.v1.ethsecp256k1.PubKey', key: 'A50rbJg3TMPACbzE5Ujg0clx+d4udBAtggqEQiB7v9Sc' }, mode_info: { single: { mode: 'SIGN_MODE_DIRECT' } }, sequence: '0' }], fee: { amount: [], gas_limit: '0', payer: '', granter: '' }, tip: null }, signatures: ['RtVlZOMVdI8IhZxSwrT7X7xakHRASwRWZL9L4MWAoTgoLnH0MfO0W/gaH99WY2w4zNSI7BVw5itwaw2DW1FswQA='] };
