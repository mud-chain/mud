...
//
// Solidity: function validators(uint8 status, (bytes,uint64,uint64,bool,bool) pageRequest) view returns((address,string,bool,uint8,uint256,uint256,(string,string,string,string,string),int64,int64,((uint256,uint256,uint256),int64),uint256)[] validators, (bytes,uint64) pageResponse)
func (_IStaking *IStakingCaller) Validators(opts *bind.CallOpts, status uint8, pageRequest PageRequest) (struct {
...
//
// Solidity: function validators(uint8 status, (bytes,uint64,uint64,bool,bool) pageRequest) view returns((address,string,bool,uint8,uint256,uint256,(string,string,string,string,string),int64,int64,((uint256,uint256,uint256),int64),uint256)[] validators, (bytes,uint64) pageResponse)
func (_IStaking *IStakingSession) Validators(status uint8, pageRequest PageRequest) (struct {
	Validators   []Validator
	PageResponse PageResponse
}, error) {
...
//
// Solidity: function validators(uint8 status, (bytes,uint64,uint64,bool,bool) pageRequest) view returns((address,string,bool,uint8,uint256,uint256,(string,string,string,string,string),int64,int64,((uint256,uint256,uint256),int64),uint256)[] validators, (bytes,uint64) pageResponse)
func (_IStaking *IStakingCallerSession) Validators(status uint8, pageRequest PageRequest) (struct {
	Validators   []Validator
	PageResponse PageResponse
}, error) {
	return _IStaking.Contract.Validators(&_IStaking.CallOpts, status, pageRequest)
